...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  ref
    ...
    const variants = {
      primary: "bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 focus:ring-gray-900 dark:focus:ring-white shadow-lg shadow-gray-900/20 dark:shadow-white/20",
      ...
      outline: "border-2 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 focus:ring-gray-500",
    ...
    return (
      <button
        ...
        className={cn(
          ...
          variants[variant],
          sizes[size],
          "transform transition-transform duration-150 hover:scale-[1.02] active:scale-[0.98]",
          className
        )}
